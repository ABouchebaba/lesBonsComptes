...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Group group = new Group(1L, "G1");
        group.save(db); // insert in db

        /////////////////////////////////////////////////////////////////////////

        Member m1 = new Member(1L, "amine", "099999999", group.getId());
        m1.save(db);

//        Member m2 = new Member(2L, "lol", "099999998", group.getId());
//        m2.save(db);
